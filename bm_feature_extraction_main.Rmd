...
cat("Complete: activity data reduced by ", 100*after/before, "% by keeping only the confidence > 50% activities for each unique timestamp \n");
...
p.codes <- c("agapantha") #c("daisy","violet","agapantha","anthurium") # pilot
for(p in p.codes){
